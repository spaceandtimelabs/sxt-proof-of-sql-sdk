// sxt-chain-sdk/index.js

class SxTProof {
    constructor(queryString, commitmentKey, apiKey) {
    ...
    async executeWorkflow() {
        ...
        // Execute the API request using makeHttpRequest
        ...
        const commitmentResponse = await makeHttpRequest({
        ...
        const proverResponse = await makeHttpRequest({
...
export default SxTProof;


async function makeHttpRequest({ url, method = "GET", headers = {}, data = null, responseType = "json" }) {
    ...
    try {
        switch (responseType) {
            case "json":
                ...
                break;
            case "arraybuffer":
                data_ = await response.arrayBuffer();
                break;
            case "text":
                data_ = await response.text();
                break;
            default:
                return { error: `Unsupported responseType: ${responseType}` };
        }
    } catch (e) {
        return { error: `Error parsing response: ${e.message}` };
    }
